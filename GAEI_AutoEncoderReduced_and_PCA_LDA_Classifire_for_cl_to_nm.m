...
pv999=[];
pv000=[];
% cl to nm where cl1 and cl2 considered as test case
for f_no=3:y1
...
csvwrite(char(strcat(path,'GEnI45_CASIA_cl_to_nmCV.csv')),cv111);
csvwrite(char(strcat(path,'GEnI45_CASIA_cl_to_nmPV.csv')),pv111);
csvwrite(char(strcat(path,'GEnI45_CASIA_cl_to_nm_Accu.csv')),accu1);